	...
	<section>
        ...
        <div class="container">
            <div class="row" class="col-md-12">
                <div id="intro">
                <img src="<?=base_url()?>assets/images/ico/pdoicon.png" width="100"> <h1> Editar Pedido de Orçamento</h1> 
            ...
            <div class="row">
                <div id="quote" class="col-md-6">
                    ...
                    <form method='post' action='<?=base_url()?>index.php/orcamentos/alterarOrcamento/<?=$orc->orcamento_id?>' id='form1' enctype="multipart/form-data">
            <input id="tags" name='titulo' type="text" value='<?=$orc->orcamento_titulo?>'> 
            <br><br>
            <p>Selecione as categorias novamente!?</p>
                <div>
           <select multiple size="26" id="filter1" name="filtro1" class="categoryfilter" style="height:220px;">
            ...
            <br>     
            <br>
            <input id="quantitybox" name='qtd' type="number" min="0" placeholder="Quantidade" value='<?=$orc->orcamento_qtd?>' oninput="validity.valid||(value='');">
                        Selecione a unidade novamente : 
            ...
            <br>
            <br>
            <textarea id ="remarkbox" name="txtDescricao" type="text"><?=$orc->orcamento_detalhes?></textarea>
                <br>
            <div id="imgbox">
            ...
            <input id="input-1" name='image5' type="file" class="file">
              ...
              <div class="panel panel-default" id="addinfobox">
                ...
                <div id="collapse1" class="panel-collapse collapse">
                  <ul class="list-group">
                    <li class="list-group-item"><p class="addprefp">Preferências de Pagamento:</p>
                        <input id="desiredprice" name='preco' type='number' value=<?=$orc->orcamento_preco?> oninput="validity.valid||(value='');"><br>
                        <?php if($orc->orcamento_creditoon == 1){ ?>
                <input name='credito' value='1' type=checkbox checked> O fornecedor aceita Cartões de Crédito.
                        <?php } else { ?>
                        <input name='credito' value='1' type=checkbox checked> O fornecedor aceita Cartões de Crédito.
                        <?php } ?>
                      </li>
                ...
                <td><input id="FOB" name='exw' value='1' type=checkbox  checked><label for="FOB"> EXW&#40;Custo do Frete é do Cliente&#41;</label></td>
                        <?php } else { ?>
                       <td><input id="FOB" name='exw' value='1' type=checkbox  ><label for="FOB"> EXW&#40;Custo do Frete é do Cliente&#41;</label></td>
                        <?php } ?>
                                      <?php if($orc->orcamento_ddpon == 1){ ?>
               <td><input id="client" name='busca' value='1' type=checkbox checked><label for="client">O Cliente retira o produto.</label></td>
                        <?php } else { ?>
                 ...
                 <td><input id="CIF" name='ddp' value='1' type=checkbox checked><label for="CIF">DDP &#40;Custo do Frete é do Fornecedor&#41;</label></td>
                        <?php } else { ?>
                          <td><input id="CIF" name='ddp' value='1' type=checkbox><label for="CIF">DDP &#40;Custo do Frete é do Fornecedor&#41;</label></td>
                        <?php } ?>
                                       <?php if($orc->orcamento_buscaon == 1){ ?>
                 
                                <td><input id="supplier" name='leva' value='1' type=checkbox checked><label for="supplier">O Fornecedor entrega o produto.</label></td>
                        <?php } else { ?>
