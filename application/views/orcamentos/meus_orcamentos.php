                        ...
                        <div id="sidebar">
                            <div class="well">       
                                <div class="btn-group radio-group nav nav-pills">
                                    <div id="pillbg">   
                                        <a href="<?=base_url()?>index.php/dashboard/"><label class="btn btn-primary active">Comprar</label></a>
                                ...
                                <div class="tab-content">
                                    <div id="menu2" class="tab-pane fade in active"><br>
                                        <ul>
                                            <a href='<?=base_url()?>index.php/dashboard/compra'><li ><span class="glyphicon glyphicon-home "></span><p> Painel de Negócios</p></li></a>
                            ...
                            <div id="anuna" class="tab-pane fade in active">
                                ...
                                <table class="tabledisplay">
                                    <tbody class="titem">
                                        <tr class="theader4" >
                                            <td></td>
                                            <td><a data-toggle="modal" data-target="#productModal"><span class="glyphicon glyphicon-unchecked"></span> Anúncio ID: <?=$anun->orcamento_id?></a></td>
                                            <td colspan="2"><p>Título</p></td>
                                            <td><p>Quantidade Solicitade</p></td>
                                            <td><p>Unidade</p></td>
                                            <td><p>Preço Unitário</p></td>
                                            <td>Ações</td>
                                        </tr>
                                        <tr class="tdata">
                                            <td colspan="2"><img class="productimg" src="<?=base_url().$anun->orcamento_imagem1?>" height="100" width="100" data-toggle="modal" data-target="#productModal"></td>
                                            <td colspan="2"><a target='_blank' href="<?=base_url()?>index.php/orcamentos/visualizarorcamento/<?= $anun->orcamento_id?>"> <?=$anun->orcamento_titulo?></a></td>    
                                            <td><p> <?=$anun->orcamento_qtd?> </p></td>
                                            <td><p> <?=$anun->orcamento_unidade?> </p></td>
                                            <td><p> R$ <?=$anun->orcamento_preco?> </p></td>
                                            <td>
                                                <div class="dropdown show">
                                                    ...
                                                    <ul id="actiondropdown" class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <li class="">
                                             <a href="<?=base_url()?>index.php/orcamentos/editarorcamento/<?=$anun->orcamento_id?>">
                                                                <span class="glyphicon glyphicon-edit"></span> Editar Orcamento</a></li>
                                                        <li><a href="#"><span class="glyphicon glyphicon-share"></span> Impulsionar Pedido!</a></li>
                                                        <li><a href="#" data-toggle="modal" data-target="#confirmationModal"><span class="glyphicon glyphicon-remove"></span>Desativar pedido de orcamento</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
